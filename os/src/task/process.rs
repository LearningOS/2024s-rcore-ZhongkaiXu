...
pub struct ProcessControlBlockInner {
    ...
    /// 是资源管理者来说 mutex资源可分配的量 动态改变
    pub mutex_available:[usize;MAX_LOCK_NUM],
    /// sem可分配资源
    pub sem_available:[usize;MAX_LOCK_NUM],
}
        ...
        let process = Arc::new(Self {
            ...
            inner: unsafe {
                UPSafeCell::new(ProcessControlBlockInner {
                    ...
                    lock_detect:false,
                    mutex_available:[0;MAX_LOCK_NUM],
                    sem_available:[0;MAX_LOCK_NUM],
                })
            },
        });
